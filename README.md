# Magento 2 Subcategories Grid List Slide Extension

[Magento 2 Subcategories Grid List Slide](https://www.ulmod.com/magento-2-categories-grid-list-slide.html)  is a Magento 2 extension that allows you to display categories and sub-categories on category, product, CMS, home, and any other pages of your site.

With Magento 2 Subcategories Grid List Slide, you can display subcategories on any page of your store, allowing buyers to find the the product they're looking for in the shortest time.

<a href="https://www.ulmod.com/magento-2-categories-grid-list-slide.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>
...
* Ability to sort subcategories by page title, name, created date, or position
* Show/hide sub-categories description and image. Ability to use a custom thumbnail image per each sub-category 
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/umcatvm-cathome2.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umcatvm-widget2.png">
